...
--6
select last_name, LPAD(TO_CHAR(salary), 15, '#') SALARY
from employees;
...
--2 날짜함수...미해결
select last_name, hire_date, NEXT_DAY(ADD_MONTH(hire_date, 6), '월')REVIEW
from employees;

--3
select last_name, hire_date, NEXT_DAY(hire_date, '월') DAY
from employees;
order by 